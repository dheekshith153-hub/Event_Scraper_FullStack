            ...
            <main className="max-w-7xl mx-auto px-4 py-8">
                ...
                {error ? (
                    ...
                    <div className="flex justify-center items-center py-24">
                        <div className="w-8 h-8 border rounded-full animate-spin" style={{ borderColor: "rgba(146, 20, 12, 0.2)", borderTopColor: "#92140c" }} />
                    </div>
                ) : allEvents.length === 0 ? (
                    <div className="text-center py-24" style={{ background: "#fff8f0", borderRadius: 24, border: "1px solid rgba(146, 20, 12, 0.1)" }}>
                        <div className="text-5xl mb-4" style={{ color: "#92140c", opacity: 0.5 }}>📭</div>
                        <p className="text-lg" style={{ color: "#1e1e24", fontFamily: "'Cormorant Garamond', serif" }}>No events found. Try adjusting your filters.</p>
                        {hasFilters && (
                            <button
                                onClick={clearAll}
